...
<script>
  function loginOut(){
	 ...
	 var flag = confirm("是否确定退出");
	  //确定退出
	  if(flag){
		//访问服务器退出 js使用location访问服务器
		location.href="${pageContext.request.contextPath}/Users/loginOut.action";
	  }
  }
</script>
...
<body>
	...
	<div id="wrapper">
		...
		<ul class="nav navbar-top-links navbar-right">
			...
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-user">
					<li><a href="${pageContext.request.contextPath }/ModifyUser.jsp"><i class="fa fa-user fa-fw"></i> 修改密码</a></li>
					<li><a href="#"><i class="fa fa-gear fa-fw"></i> 系统设置</a></li>
					<li class="divider"></li>
					<!-- javascript:void(0) 阻止后续运行，可以让href属性失效-->
					<li><a href="javascript:void(0)" onclick="loginOut()"><i class="fa fa-sign-out fa-fw"></i>
							退出登录</a></li>
				</ul> <!-- /.dropdown-user --></li>
			<!-- /.dropdown -->
		</ul>
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#customerAddDialog" "><i
							class="fa fa-edit fa-fw"></i> -新增客户</a></li>
							
					<li><a href="${pageContext.request.contextPath }/customer/list.action" class="active"><i
							class="fa fa-edit fa-fw"></i> -客户列表</a></li>
					<li><a href="#"><i
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<marquee><h1 class="page-header" style="color: green">客户管理-->当前用户:${user.userName }</h1></marquee>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
	...
	<div class="modal fade" id="customerAddDialog" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
					<button type="button" class="btn btn-primary" onclick="addCustomer()">保存添加</button>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function addCustomer(){
				...
				$.post("${pageContext.request.contextPath}/customer/add.action",$("#add_customer_form").serialize(),function(data){
				if(data=="0"){
					alert("客户添加成功!");
				}else{
					alert("客户添加失败");
