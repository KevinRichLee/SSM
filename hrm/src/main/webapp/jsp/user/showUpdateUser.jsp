...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/user/modifyUser.do?ID=${user.ID}" id="userForm" method="post" >
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr><td align="left" class="fftd"><input type="submit" value="修改" id="login-submit-btn">&nbsp;&nbsp;<input type="reset" value="取消 " onClick="javascript :history.back(-1)"></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
