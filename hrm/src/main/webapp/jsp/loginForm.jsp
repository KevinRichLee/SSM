		...
		<form action="${pageContext.request.contextPath}/user/login.do" method="post" id="loginForm">
			<div class="page-body">
				...
				<div class="page-lock-info">
					<span>&nbsp;</span> 
					<c:choose>
						<c:when test="${requestScope.loginUser == null }">
							<span style="padding-top: 5px"><font color="red">${error}</font></span>
						</c:when>
						<c:otherwise>
							<span style="padding-top: 5px"><font color="red">${errorlogin}</font></span>
						</c:otherwise>
					</c:choose>
